...
<head>
    ...
    <link href=rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN"
        ...
        <form id="form" action="./backend/functionCadastro.php" method="POST" class="">
            <div class="form-group">
                <div class="row">
                    ...
                    <button title="Editar" type="button" class="btn btn-danger" id="btnEditar"
                        onclick="atualizarInfo('btnEditar');"><i class="bi bi-pencil-square"></i></button>
                    <div class="col-lg-6">
                        <?php 
...
$result = $conn->query($sql);*/
                        ...
                        <input type="text" class="form-control" id="nome" pattern="[^0-9]*" name="nome"
                            placeholder="João" value="<?php echo $dado['nome']; ?>" required >
                    </div>
                    <div class="col-lg-6">
                        <label for="sobrenome" class="form-label">Sobrenome:</label>
                        <input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="Silva"
                            value="<?php echo $dado['sobrenome']; ?>" required>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="telefone" name="telefone"
                            placeholder="Apenas números" value="<?php echo $dado['telefone']; ?>" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="cpf" name="cpf" placeholder="Apenas números"
                            value="<?php echo $dado['cpf']; ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="cep" name="cep" size="10" maxlength="9"
                            onblur="pesquisacep(this.value);" onkeyup="formatarCEP(this);"
                            value="<?php echo $dado['cep']; ?>" placeholder="Apenas n.º" required>
                        <span class="span-required">CEP Inválido!</span>
                    </div>
                    <div class="col-md-7">
                        <label for="rua" class="form-label">Rua:</label>
                        <input type="text" class="form-control" id="rua" name="rua" placeholder="Sua rua"
                            value="<?php echo $dado['rua']; ?>" required disabled>
                        <input type="hidden" id="rua_oculto" name="rua_oculto" value="">
                    </div>
                    <div class="col-md-2">
                        <label for="num" class="form-label">Nº ou Apto:</label>
                        <input type="text" class="form-control" id="num" name="num" placeholder="202-A"
                            value="<?php echo $dado['numero']; ?>" required>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="bairro" name="bairro" placeholder="Seu bairro"
                            value="<?php echo $dado['bairro']; ?>" required disabled>
                        <input type="hidden" id="bairro_oculto" name="bairro_oculto" value="">
                    </div>
                    <div class="col-md-7">
                        <label for="cidade" class="form-label">Cidade:</label>
                        <input type="text" class="form-control" id="cidade" name="cidade" placeholder="Cidade"
                            value="<?php echo $dado['cidade']; ?>" required disabled>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="uf" name="uf" placeholder="UF"
                            value="<?php echo $dado['uf']; ?>" required disabled>
            ...
            <div class="align-items-center">
                ...
                <div class="form-group mx-auto">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="nome@email.com"
                        value="<?php echo $dado['email']; ?>" disabled>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="password" class="form-control" id="senhaAntiga" name="senha"
                            placeholder="*********" required disabled>
                    </div>
                    <div class="align-items-center d-flex flex-column col-md-2">
                        <button type="button" id="btnSenha" class="btnSenha"
                            onclick="atualizarInfo('btnSenha');">Atualizar senha</button>
                    </div>
                    <div class="col-md-6">
                        <label for="senha" class="form-label">Nova senha:</label>
                        <input type="password" class="form-control" id="senhaNova" name="senha" placeholder="*********"
                            required disabled>
                    </div>
                    <div class="align-items-center d-flex flex-column" style="padding-top: 3%;">
                        <button type="button" id="btnAtualizar" class="btn btn-primary btn-lg"
                            onclick="atualizarInfo('btnAtualizar');" disabled>Atualizar
                            informações</button>
                    </div>
                </div>
            </div>
